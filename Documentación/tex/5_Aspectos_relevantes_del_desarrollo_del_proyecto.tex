...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.33\textwidth]{Imagen_compuesta}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.33\textwidth]{Mascara_tif}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.3\textwidth]{Metricas_KNN}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.3\textwidth]{Metricas_Random_Forest}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=1\textwidth]{Unet_clasificacion_5_bandas_40_epocas_con_dropout_din_threshold}
